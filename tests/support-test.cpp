...
template <typename T> void testSupport() {
  ...
  grid grid1 = std::make_shared<const std::vector<T>>(std::vector<T>{
  ...
  grid grid11 = std::make_shared<const std::vector<T>>(std::vector<T>{
      -7.0l,  -6.85l, -6.55l, -6.3l, -6.0l, -5.75l, -5.53l, -5.2l,
      -4.75l, -4.5l,  -3.0l,  -2.5l, -1.5l, -1.0l,  0.0l,   0.5l,
      1.5l,   2.5l,   3.5l,   4.0l,  4.35l, 4.55l,  4.95l,  5.4l,
      5.7l,   6.1l,   6.35l,  6.5l,  6.85l, 7.0l});
  ...
  grid grid2 = std::make_shared<const std::vector<T>>(std::vector<T>{
      -7.0l,  -6.85l, -6.55l, -6.3l, -6.0l, -5.75l, -5.53l, -5.2l,
      -4.75l, -4.5l,  -3.0l,  -2.5l, -1.5l, -1.0l,  0.0l,   0.5l,
      1.53l,  2.5l,   3.5l,   4.0l,  4.35l, 4.55l,  4.95l,  5.4l,
      5.7l,   6.1l,   6.35l,  6.5l,  6.85l, 7.0l});

  // Represents a different grid than grid1
  grid grid3 = std::make_shared<const std::vector<T>>(std::vector<T>{
      -7.0l,  -6.85l, -6.55l, -6.3l, -6.0l, -5.75l, -5.53l, -5.2l,
      -4.75l, -4.5l,  -3.0l,  -2.5l, -1.5l, -1.0l,  0.0l,   0.5l,
      1.5l,   2.5l,   3.5l,   4.0l,  4.35l, 4.55l,  4.95l,  5.4l,
      5.7l,   6.1l,   6.35l,  6.5l,  6.85l, 7.0l,   8.0l});
